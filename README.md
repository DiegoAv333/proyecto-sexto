📱 Nombre de la App: “Inscribite Ya”
...
1. Clonar el repositorio:
   ...
   ```bash
   git clone https://github.com/usuario/inscribite-ya.git
   cd inscribite-ya
   ```
...
5. Generar versión para producción:

   ```bash
   npm run build
   ```

6. Desplegar (ejemplo con Vercel):
   - Crear cuenta en [https://vercel.com](https://vercel.com)
   - Conectar el repositorio de GitHub
   - Vercel detectará el framework automáticamente y generará la URL pública
